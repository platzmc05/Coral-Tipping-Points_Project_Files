...
Increasing sea temperatures are known to cause coral stress and make them more susceptible to threats such as disease. Degree heating weeks (DHW) are a measure of how much heat stress has accumulated in a region over a period of 3 months, and are a metric that is used to predict mass bleaching events. A plot of average monthly regional sea surface temperature (SST) and degree heating weeks shows that SST is rising over the period 2012 - 2020 and the frequency of DHW has increased.
...
- Twitter discourse 
- (https://github.com/platzmc05/Coral-Tipping-Points_Project_Files/raw/master/figures/Twitter_data.png)
- (https://github.com/platzmc05/Coral-Tipping-Points_Project_Files/raw/master/figures/Twitter_data2.png)
- (https://github.com/platzmc05/Coral-Tipping-Points_Project_Files/raw/master/figures/Frequencyofwords.png)
- TripAdvisor reviews  
