...
(insery image of SCTLD infected coral??)
...
(insert conceptual model image here)  
...
In regard to the social component, there are several databases available that offer quantitative and qualitative insights. For instance, while databases such as STR for hotel data or annual tourism reports can offer quantitative insights of the changes in tourism, the social media databases complement with qualitative insights on the depth of those changes, capturing a wider range of perceptions including both locals and tourists. Here we explote: 
- Twitter discourse 
- TripAdvisor reviews 
