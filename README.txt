...
This repository contains data to assess social-ecological tipping points associated with the Stony Coral Tissue Loss Disease event in the Florida Reef Tract. Through an assessment of social and ecological datasets, we hope to identify correlations and understand tipping point dynamics to answer research questions such as: what is the lag time between an environmental catastrophe and the social response?

Datasets we intend to utilize include: 
-	Twitter data from 2012-present (time of tweet)
